// Video and Audio control for DJ AI Studio project
...
document.addEventListener('DOMContentLoaded', function() {
    video = document.getElementById('dj-ai-studio-video');
    
    // Create audio element for background music (update path as needed)
